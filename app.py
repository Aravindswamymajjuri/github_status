...
try:
    ...
    from modes.team_dashboard import render_team_dashboard
...
def main():
    ...
    gitlab_token = st.sidebar.text_input(
        "GitLab Token", value=default_token, type="password"
    )
    ...
    elif mode == "Team Analytics":
        csv_path = "Teams/team.csv"

        if os.path.exists(csv_path):
            render_team_dashboard(client, csv_path)
        else:
