...
def get_user_commits(client, user, projects, date_range=None):
    """
    ...
    stats = {
        ...
        "afternoon_commits": 0, # 12:30 PM – 05:00 PM
        "other_commits": 0,     # 05:00 PM – 09:30 AM
    }
    ...
    for project in projects:
        try:
            ...
            params = apply_range_params(
                {"author": author_name or username, "all": "true"},
                date_range,
                "since",
                "until",
            )
