...
def get_user_mrs(client, user_id, date_range=None):
    """
    ...
    def fetch_and_add(base_params, role_label):
        try:
            params = apply_range_params(base_params, date_range, "created_after", "created_before")
